"use strict";var jt=Object.create;var Y=Object.defineProperty;var Vt=Object.getOwnPropertyDescriptor;var Yt=Object.getOwnPropertyNames;var qt=Object.getPrototypeOf,Kt=Object.prototype.hasOwnProperty;var Jt=(r,e)=>{for(var t in e)Y(r,t,{get:e[t],enumerable:!0})},he=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Yt(e))!Kt.call(r,n)&&n!==t&&Y(r,n,{get:()=>e[n],enumerable:!(s=Vt(e,n))||s.enumerable});return r};var X=(r,e,t)=>(t=r!=null?jt(qt(r)):{},he(e||!r||!r.__esModule?Y(t,"default",{value:r,enumerable:!0}):t,r)),Qt=r=>he(Y({},"__esModule",{value:!0}),r);var Us={};Jt(Us,{generateContext:()=>Wt,generateContextWithStats:()=>be});module.exports=Qt(Us);var Ht=X(require("path"),1),Gt=require("os"),Bt=require("fs");var le=require("bun:sqlite"),J=require("fs");var S=require("path"),ae=require("os"),F=require("fs"),Ie=require("url");var g=require("fs"),Ne=require("crypto"),y=require("path");var zt=null;function Zt(r){return(zt??process.stderr.write.bind(process.stderr))(r)}function k(r){Zt(r)}var es=process.platform==="win32";function ts(r){return r.replace(/^\uFEFF/,"")}function w(r){return JSON.parse(ts(r))}function ss(r){(0,g.existsSync)(r)||(0,g.mkdirSync)(r,{recursive:!0})}function ie(r,e,t){let s=r;try{if((0,g.lstatSync)(r).isSymbolicLink())try{s=(0,g.realpathSync)(r)}catch(u){let c=u instanceof Error?u:new Error(String(u));k(`claude-mem: realpathSync failed for ${r}, resolving symlink manually: ${c.message}
`);let p=(0,g.readlinkSync)(r);s=(0,y.resolve)((0,y.dirname)(r),p)}}catch(u){let c=u.code;if(c!=="ENOENT"&&c!=="ENOTDIR")throw u}ss((0,y.dirname)(s));let n=(0,y.dirname)(s),o=(0,y.basename)(s),i=(0,y.join)(n,`.${o}.${process.pid}.${(0,Ne.randomBytes)(6).toString("hex")}.tmp`),a=Buffer.from(JSON.stringify(e,null,2)+`
...
`+JSON.stringify(o,null,2)}catch{u=" "+this.formatData(o)}else u=" "+this.formatData(o);let c="";if(n){let{sessionId:T,memorySessionId:N,correlationId:h,...f}=n;Object.keys(f).length>0&&(c=` {${Object.entries(f).map(([C,U])=>`${C}=${U}`).join(", ")}}`)}let p=`[${i}] [${a}] [${d}] ${E}${s}${c}${u}`;if(this.logFilePath)try{(0,v.appendFileSync)(this.logFilePath,p+`
`,"utf8")}catch(T){let N=T instanceof Error?T:new Error(String(T));k(`[LOGGER] Failed to write to log file: ${N.message}
${N.stack??""}
`)}else k(p+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}setErrorSink(e){Ee=e}error(e,t,s,n){this.log(3,e,t,s,n),this.routeErrorToSink(t,s,n)}routeErrorToSink(e,t,s){try{if(!Ee||!ue(s))return;Ee(s instanceof Error?s:new Error(s.message))}catch{}}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}},_=new ce;var Me=require("crypto");function ye(r,e,t){return(0,Me.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}var l="claude";function _s(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function L(r){if(!r)return l;let e=_s(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:l}function ve(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ue(r,e,t,s,n){let o=Date.now()-s,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return r.prepare(`
  ...
  `).get()!=null}function P(r,e,t){try{r.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw _.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function Xe(r,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;P(r,`PRAGMA busy_timeout = ${cs}`,"busy_timeout"),P(r,"PRAGMA foreign_keys = ON","foreign_keys"),P(r,"PRAGMA synchronous = NORMAL","synchronous"),P(r,`PRAGMA journal_size_limit = ${ps}`,"journal_size_limit"),s&&!ls(r)&&P(r,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&P(r,"PRAGMA journal_mode = WAL","journal_mode")}var K=class{db;constructor(e=Ae,t={}){e instanceof le.Database?this.db=e:(e!==":memory:"&&Le(I),this.db=new le.Database(e)),Xe(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(t.cloudSyncStatePath??x.cloudSyncState()),this.requeuePromptCloudSyncAfterMapperFix(),this.createAttentionItemsTable()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let o=this.getIndexColumns(n.name);return o.length===t.length&&o.every((i,a)=>i===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let n=s?L(s):void 0;return n?this.db.prepare(`
    ...
    `).get(e,L(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i,type:a,concepts:d,files:E}=t,u=s==="relevance",c=u?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,p=n&&!u?`LIMIT ${n}`:"",T=e.map(()=>"?").join(","),N=[...e],h=[];if(o&&(h.push("o.project = ?"),N.push(o)),i&&(h.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),N.push(L(i))),a)if(Array.isArray(a)){let A=a.map(()=>"?").join(",");h.push(`o.type IN (${A})`),N.push(...a)}else h.push("o.type = ?"),N.push(a);if(d){let A=Array.isArray(d)?d:[d],b=A.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");N.push(...A),h.push(`(${b.join(" OR ")})`)}if(E){let A=Array.isArray(E)?E:[E],b=A.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");A.forEach(D=>{N.push(`%${D}%`,`%${D}%`)}),h.push(`(${b.join(" OR ")})`)}let f=h.length>0?`WHERE o.id IN (${T}) AND ${h.join(" AND ")}`:`WHERE o.id IN (${T})`,C=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${f}
      ${c}
      ${p}
    `).all(...N);if(!u)return C;let U=new Map(C.map(A=>[A.id,A])),R=e.map(A=>U.get(A)).filter(A=>!!A);return n?R.slice(0,n):R}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let E=a??Date.now(),u=new Date(E).toISOString();return this.db.transaction(()=>{let p=[],T=this.db.prepare(`
        ...
        RETURNING id
      `),N=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let f of s){let O=ye(e,f.title,f.narrative),C=T.get(e,t,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),o||null,i,f.agent_type??null,f.agent_id??null,O,u,E,d||null,f.metadata??null);if(C){p.push(C.id);continue}let U=N.get(e,O);if(!U)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${O}`);p.push(U.id)}let h=null;if(n){let O=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,u,E);h=Number(O.lastInsertRowid)}return{observationIds:p,summaryId:h,createdAtEpoch:E}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,E=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),c=[...e],p=[];o&&(p.push("ss.project = ?"),c.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),c.push(L(i)));let T=p.length>0?`AND ${p.join(" AND ")}`:"",h=this.db.prepare(`
      SELECT ss.*
    ...
    `).all(...c);if(!a)return h;let f=new Map(h.map(C=>[C.id,C])),O=e.map(C=>f.get(C)).filter(C=>!!C);return n?O.slice(0,n):O}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,E=n?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),c=[...e],p=[];o&&(p.push("s.project = ?"),c.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),c.push(L(i)));let T=p.length>0?`AND ${p.join(" AND ")}`:"",h=this.db.prepare(`
      ...
      ${d}
      ${E}
    `).all(...c);if(!a)return h;let f=new Map(h.map(O=>[O.id,O]));return e.map(O=>f.get(O)).filter(O=>!!O)}getTimelineAroundTimestamp(e,t=10,s=10,n,o){return this.getTimelineAroundObservation(null,e,t,s,n,o)}getTimelineAroundObservation(e,t,s=10,n=10,o,i){let a=i?L(i):void 0,d=(R,A)=>{let b=[],D=[];return o&&(b.push(`${R}.project = ?`),D.push(o)),a&&(b.push(`COALESCE(NULLIF(${A}.platform_source, ''), '${l}') = ?`),D.push(a)),{clause:b.length>0?`AND ${b.join(" AND ")}`:"",params:D}},E=d("o","src"),u=d("ss","src"),c=d("s","s"),p,T;if(e!==null){let R=`
      ...
      `,A=`
        ...
        LIMIT ?
      `;try{let b=this.db.prepare(R).all(t,...E.params,s),D=this.db.prepare(A).all(t,...E.params,n+1);if(b.length===0&&D.length===0)return{observations:[],sessions:[],prompts:[]};p=b.length>0?b[b.length-1].created_at_epoch:t,T=D.length>0?D[D.length-1].created_at_epoch:t}catch(b){return b instanceof Error?_.error("DB","Error getting boundary timestamps",{project:o},b):_.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(b))),{observations:[],sessions:[],prompts:[]}}}let N=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
