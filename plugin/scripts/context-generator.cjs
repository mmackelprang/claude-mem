"use strict";var jt=Object.create;var Y=Object.defineProperty;var Vt=Object.getOwnPropertyDescriptor;var Yt=Object.getOwnPropertyNames;var qt=Object.getPrototypeOf,Kt=Object.prototype.hasOwnProperty;var Jt=(r,e)=>{for(var t in e)Y(r,t,{get:e[t],enumerable:!0})},Ne=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Yt(e))!Kt.call(r,n)&&n!==t&&Y(r,n,{get:()=>e[n],enumerable:!(s=Vt(e,n))||s.enumerable});return r};var X=(r,e,t)=>(t=r!=null?jt(qt(r)):{},Ne(e||!r||!r.__esModule?Y(t,"default",{value:r,enumerable:!0}):t,r)),Qt=r=>Ne(Y({},"__esModule",{value:!0}),r);var Us={};Jt(Us,{generateContext:()=>Wt,generateContextWithStats:()=>be});module.exports=Qt(Us);var Ht=X(require("path"),1),Gt=require("os"),Bt=require("fs");var le=require("bun:sqlite"),J=require("fs");var S=require("path"),ae=require("os"),P=require("fs"),Ie=require("url");var g=require("fs"),he=require("crypto"),y=require("path");var zt=null;function Zt(r){return(zt??process.stderr.write.bind(process.stderr))(r)}function k(r){Zt(r)}var es=process.platform==="win32";function ts(r){return r.replace(/^\uFEFF/,"")}function w(r){return JSON.parse(ts(r))}function ss(r){(0,g.existsSync)(r)||(0,g.mkdirSync)(r,{recursive:!0})}function ie(r,e,t){let s=r;try{if((0,g.lstatSync)(r).isSymbolicLink())try{s=(0,g.realpathSync)(r)}catch(u){let c=u instanceof Error?u:new Error(String(u));k(`claude-mem: realpathSync failed for ${r}, resolving symlink manually: ${c.message}
`);let p=(0,g.readlinkSync)(r);s=(0,y.resolve)((0,y.dirname)(r),p)}}catch(u){let c=u.code;if(c!=="ENOENT"&&c!=="ENOTDIR")throw u}ss((0,y.dirname)(s));let n=(0,y.dirname)(s),o=(0,y.basename)(s),i=(0,y.join)(n,`.${o}.${process.pid}.${(0,he.randomBytes)(6).toString("hex")}.tmp`),a=Buffer.from(JSON.stringify(e,null,2)+`
`,"utf-8"),d;try{d=(0,g.statSync)(s).mode&511}catch{d=t}let E;try{E=d!==void 0?(0,g.openSync)(i,"w",d):(0,g.openSync)(i,"w");let u=0;for(;u<a.length;){let c=(0,g.writeSync)(E,a,u,a.length-u);if(c===0)throw new Error(`writeSync stalled at ${u}/${a.length} bytes`);u+=c}if((0,g.fsyncSync)(E),(0,g.closeSync)(E),E=void 0,(0,g.renameSync)(i,s),!es){let c;try{c=(0,g.openSync)(n,"r"),(0,g.fsyncSync)(c)}catch(p){let T=p instanceof Error?p:new Error(String(p));k(`claude-mem: directory fsync failed for ${n}: ${T.message}
`)}finally{if(c!==void 0)try{(0,g.closeSync)(c)}catch{}}}}catch(u){if(E!==void 0)try{(0,g.closeSync)(E)}catch{}try{(0,g.unlinkSync)(i)}catch{}throw u}}var ds={};function rs(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,Ie.fileURLToPath)(ds.url))}var ns=rs();function os(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,ae.homedir)(),".claude-mem"),e=(0,S.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let t=w((0,P.readFileSync)(e,"utf-8")),s=t.env??t;if(s.CLAUDE_MEM_DATA_DIR)return s.CLAUDE_MEM_DATA_DIR}}catch{}return r}var I=os(),de=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,ae.homedir)(),".claude"),Xs=(0,S.join)(de,"plugins","marketplaces","thedotmack"),is=(0,S.join)(I,"logs"),Hs=(0,S.join)(I,"settings.json"),Ae=(0,S.join)(I,"claude-mem.db"),as=(0,S.join)(I,"observer-sessions"),_e=(0,S.basename)(as);function Le(r){(0,P.mkdirSync)(r,{recursive:!0})}function Ce(){return(0,S.join)(ns,"..")}var x={dataDir:()=>I,workerPid:()=>(0,S.join)(I,"worker.pid"),serverPid:()=>(0,S.join)(I,".server-beta.pid"),serverPort:()=>(0,S.join)(I,".server-beta.port"),serverRuntime:()=>(0,S.join)(I,".server-beta.runtime.json"),settings:()=>(0,S.join)(I,"settings.json"),database:()=>(0,S.join)(I,"claude-mem.db"),chroma:()=>(0,S.join)(I,"chroma"),combinedCerts:()=>(0,S.join)(I,"combined_certs.pem"),transcriptsConfig:()=>(0,S.join)(I,"transcript-watch.json"),transcriptsState:()=>(0,S.join)(I,"transcript-watch-state.json"),cloudSyncState:()=>(0,S.join)(I,"cloud-sync-state.json"),corpora:()=>(0,S.join)(I,"corpora"),supervisorRegistry:()=>(0,S.join)(I,"supervisor.json"),envFile:()=>(0,S.join)(I,".env"),logsDir:()=>is};var v=require("fs"),De=require("path");var me=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(me||{}),Ee=null;function ue(r){return r instanceof Error||typeof r=="object"&&r!==null&&typeof r.message=="string"}var ce=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=x.logsDir();(0,v.existsSync)(e)||(0,v.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,De.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=x.settings();if((0,v.existsSync)(e)){let t=(0,v.readFileSync)(e,"utf-8"),n=(w(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=me[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(ue(e)){let s=e.stack;return this.getLevel()===0&&s?`${e.message}
${s}`:e.message}if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),d=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${a}.${d}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=me[e].padEnd(5),d=t.padEnd(6),E="";n?.correlationId?E=`[${n.correlationId}] `:n?.sessionId&&(E=`[session-${n.sessionId}] `);let u="";if(o!=null)if(ue(o)){let T=o.stack;u=this.getLevel()===0&&T?`
${o.message}
${T}`:` ${o.message}`}else if(this.getLevel()===0&&typeof o=="object")try{u=`
`+JSON.stringify(o,null,2)}catch{u=" "+this.formatData(o)}else u=" "+this.formatData(o);let c="";if(n){let{sessionId:T,memorySessionId:h,correlationId:N,...f}=n;Object.keys(f).length>0&&(c=` {${Object.entries(f).map(([C,U])=>`${C}=${U}`).join(", ")}}`)}let p=`[${i}] [${a}] [${d}] ${E}${s}${c}${u}`;if(this.logFilePath)try{(0,v.appendFileSync)(this.logFilePath,p+`
`,"utf8")}catch(T){let h=T instanceof Error?T:new Error(String(T));k(`[LOGGER] Failed to write to log file: ${h.message}
${h.stack??""}
`)}else k(p+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}setErrorSink(e){Ee=e}error(e,t,s,n){this.log(3,e,t,s,n),this.routeErrorToSink(t,s,n)}routeErrorToSink(e,t,s){try{if(!Ee||!ue(s))return;Ee(s instanceof Error?s:new Error(s.message))}catch{}}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}},_=new ce;var Me=require("crypto");function ye(r,e,t){return(0,Me.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}var l="claude";function _s(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function L(r){if(!r)return l;let e=_s(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:l}function ve(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Ue(r,e,t,s,n){let o=Date.now()-s,i=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return r.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,t,o)??void 0}var Pe=["claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],xe=new RegExp(`<(${Pe.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),ke=/<(private[a-z0-9_-]*)\b[^>]*>[\s\S]*?<\/\1>/gi,Fe=/<system-reminder>[\s\S]*?<\/system-reminder>/g,we=100;function Es(r){let e=Object.fromEntries(Pe.map(o=>[o,0]));e.private=0,ke.lastIndex=0;let t=0,s=r.replace(ke,()=>(e.private+=1,t+=1,""));xe.lastIndex=0;let n=s.replace(xe,(o,i)=>(e[i]=(e[i]??0)+1,t+=1,""));return t>we&&_.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:we,contentLength:r.length}),{stripped:n.trim(),counts:e}}function $e(r){return Es(r).stripped}var us=["task-notification"],zs=new RegExp(`^\\s*<(${us.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),Zs=256*1024;var pe=4e3;function q(r){let e=r.trim(),s=$e(r).trim()||e;return s.length<=pe?s:(_.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:pe}),`${s.slice(0,pe-1)}\u2026`)}var ms=require("bun:sqlite");var cs=5e3,ps=4194304;function ls(r){return r.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
      AND name NOT LIKE 'sqlite_%'
    LIMIT 1
  `).get()!=null}function F(r,e,t){try{r.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw _.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function Xe(r,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;F(r,`PRAGMA busy_timeout = ${cs}`,"busy_timeout"),F(r,"PRAGMA foreign_keys = ON","foreign_keys"),F(r,"PRAGMA synchronous = NORMAL","synchronous"),F(r,`PRAGMA journal_size_limit = ${ps}`,"journal_size_limit"),s&&!ls(r)&&F(r,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&F(r,"PRAGMA journal_mode = WAL","journal_mode")}var K=class{db;constructor(e=Ae,t={}){e instanceof le.Database?this.db=e:(e!==":memory:"&&Le(I),this.db=new le.Database(e)),Xe(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(t.cloudSyncStatePath??x.cloudSyncState()),this.requeuePromptCloudSyncAfterMapperFix(),this.createAttentionItemsTable()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(t=>t.name)}hasUniqueIndexOnColumns(e,t){return this.db.query(`PRAGMA index_list(${e})`).all().some(n=>{if(n.unique!==1)return!1;let o=this.getIndexColumns(n.name);return o.length===t.length&&o.every((i,a)=>i===t[a])})}resolvePromptSessionDbId(e,t,s){if(t!==void 0)return t;let n=s?L(s):void 0;return n?this.db.prepare(`
        SELECT id
        FROM sdk_sessions
    ...
    `).run();_.info("DB","Requeued prompt cloud sync after mapper fix (v40)",{requeued:t.changes}),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(40,new Date().toISOString())}createAttentionItemsTable(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(41))return;if(this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='attention_items'").all().length>0){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(41,new Date().toISOString());return}this.db.run(`
    ...
    `).get(e,L(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i,type:a,concepts:d,files:E}=t,u=s==="relevance",c=u?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,p=n&&!u?`LIMIT ${n}`:"",T=e.map(()=>"?").join(","),h=[...e],N=[];if(o&&(N.push("o.project = ?"),h.push(o)),i&&(N.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),h.push(L(i))),a)if(Array.isArray(a)){let A=a.map(()=>"?").join(",");N.push(`o.type IN (${A})`),h.push(...a)}else N.push("o.type = ?"),h.push(a);if(d){let A=Array.isArray(d)?d:[d],b=A.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");h.push(...A),N.push(`(${b.join(" OR ")})`)}if(E){let A=Array.isArray(E)?E:[E],b=A.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");A.forEach(D=>{h.push(`%${D}%`,`%${D}%`)}),N.push(`(${b.join(" OR ")})`)}let f=N.length>0?`WHERE o.id IN (${T}) AND ${N.join(" AND ")}`:`WHERE o.id IN (${T})`,C=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${f}
      ${c}
      ${p}
    `).all(...h);if(!u)return C;let U=new Map(C.map(A=>[A.id,A])),R=e.map(A=>U.get(A)).filter(A=>!!A);return n?R.slice(0,n):R}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,t,s,n,o){let i=new Date,a=i.getTime(),d=o?L(o):l,E=q(s),u=this.db.prepare(`
    ...
    `).get(l,d,e);if(u)return t&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,d,E,n||null,i.toISOString(),a);return Number(c.lastInsertRowid)}saveUserPrompt(e,t,s,n){let o=new Date,i=o.getTime(),a=q(s),d=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=this.storeObservations(e,t,[s],null,n,o,i,a);return{id:d.observationIds[0],createdAtEpoch:d.createdAtEpoch}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),u=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let E=a??Date.now(),u=new Date(E).toISOString();return this.db.transaction(()=>{let p=[],T=this.db.prepare(`
        ...
        RETURNING id
      `),h=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let f of s){let O=ye(e,f.title,f.narrative),C=T.get(e,t,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),o||null,i,f.agent_type??null,f.agent_id??null,O,u,E,d||null,f.metadata??null);if(C){p.push(C.id);continue}let U=h.get(e,O);if(!U)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${O}`);p.push(U.id)}let N=null;if(n){let O=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,u,E);N=Number(O.lastInsertRowid)}return{observationIds:p,summaryId:N,createdAtEpoch:E}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,E=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),c=[...e],p=[];o&&(p.push("ss.project = ?"),c.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),c.push(L(i)));let T=p.length>0?`AND ${p.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT ss.*
      ...
      ${d}
      ${E}
    `).all(...c);if(!a)return N;let f=new Map(N.map(C=>[C.id,C])),O=e.map(C=>f.get(C)).filter(C=>!!C);return n?O.slice(0,n):O}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,platformSource:i}=t,a=s==="relevance",d=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,E=n?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),c=[...e],p=[];o&&(p.push("s.project = ?"),c.push(o)),i&&(p.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),c.push(L(i)));let T=p.length>0?`AND ${p.join(" AND ")}`:"",N=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${d}
      ${E}
    `).all(...c);if(!a)return N;let f=new Map(N.map(O=>[O.id,O]));return e.map(O=>f.get(O)).filter(O=>!!O)}getTimelineAroundTimestamp(e,t=10,s=10,n,o){return this.getTimelineAroundObservation(null,e,t,s,n,o)}getTimelineAroundObservation(e,t,s=10,n=10,o,i){let a=i?L(i):void 0,d=(R,A)=>{let b=[],D=[];return o&&(b.push(`${R}.project = ?`),D.push(o)),a&&(b.push(`COALESCE(NULLIF(${A}.platform_source, ''), '${l}') = ?`),D.push(a)),{clause:b.length>0?`AND ${b.join(" AND ")}`:"",params:D}},E=d("o","src"),u=d("ss","src"),c=d("s","s"),p,T;if(e!==null){let R=`
      ...
      `,A=`
        ...
        ORDER BY o.id ASC
        LIMIT ?
      `;try{let b=this.db.prepare(R).all(e,...E.params,s+1),D=this.db.prepare(A).all(e,...E.params,n+1);if(b.length===0&&D.length===0)return{observations:[],sessions:[],prompts:[]};p=b.length>0?b[b.length-1].created_at_epoch:t,T=D.length>0?D[D.length-1].created_at_epoch:t}catch(b){return b instanceof Error?_.error("DB","Error getting boundary observations",{project:o},b):_.error("DB","Error getting boundary observations with non-Error",{},new Error(String(b))),{observations:[],sessions:[],prompts:[]}}}else{let R=`
      ...
      `,A=`
        ...
        LIMIT ?
      `;try{let b=this.db.prepare(R).all(t,...E.params,s),D=this.db.prepare(A).all(t,...E.params,n+1);if(b.length===0&&D.length===0)return{observations:[],sessions:[],prompts:[]};p=b.length>0?b[b.length-1].created_at_epoch:t,T=D.length>0?D[D.length-1].created_at_epoch:t}catch(b){return b instanceof Error?_.error("DB","Error getting boundary timestamps",{project:o},b):_.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(b))),{observations:[],sessions:[],prompts:[]}}}let h=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
    ...
    `,O=this.db.prepare(h).all(p,T,...E.params),C=this.db.prepare(N).all(p,T,...u.params),U=this.db.prepare(f).all(p,T,...c.params);return{observations:O,sessions:C.map(R=>({id:R.id,memory_session_id:R.memory_session_id,project:R.project,request:R.request,completed:R.completed,next_steps:R.next_steps,created_at:R.created_at,created_at_epoch:R.created_at_epoch})),prompts:U.map(R=>({id:R.id,content_session_id:R.content_session_id,prompt_number:R.prompt_number,prompt_text:R.prompt_text,project:R.project,platform_source:R.platform_source,created_at:R.created_at,created_at_epoch:R.created_at_epoch}))}}getOrCreateManualSession(e){let t=`manual-${e}`,s=`manual-content-${e}`;if(this.db.prepare("SELECT memory_session_id FROM sdk_sessions WHERE memory_session_id = ?").get(t))return t;let o=new Date;return this.db.prepare(`
      INSERT INTO sdk_sessions (memory_session_id, content_session_id, project, platform_source, started_at, started_at_epoch, status)
      VALUES (?, ?, ?, ?, ?, ?, 'active')
    `).run(t,s,e,l,o.toISOString(),o.getTime()),_.info("SESSION","Created manual session",{memorySessionId:t,project:e}),t}close(){this.db.close()}importSdkSession(e){let t=L(e.platform_source),s=this.db.prepare(`SELECT id FROM sdk_sessions
...
`}function yt(r,e,t,s){let n=[];return s?n.push(...St(r)):n.push(...it(r)),s?n.push(...ft()):n.push(...at()),s&&(n.push(...Ot()),n.push(...Rt())),te(t)&&(s?n.push(...bt(e,t)):n.push(...dt(e,t))),n}var fe=X(require("path"),1);function oe(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function Oe(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Re(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Ut(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function vt(r,e){return fe.default.isAbsolute(r)?fe.default.relative(e,r):r}function xt(r,e,t){let s=oe(r);if(s.length>0)return vt(s[0],e);if(t){let n=oe(t);if(n.length>0)return vt(n[0],e)}return"General"}function Ns(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=Ut(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function kt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?oe(r.facts).join(`
`):null}function hs(r,e,t,s){let n=[];n.push(..._t(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=Oe(a.displayTime);n.push(...ct(a,d))}else{let a=i.data,d=Re(a.created_at),u=d!==o?d:"";if(o=d,t.has(a.id)){let p=kt(a,s);n.push(...mt(a,u,p,s))}else n.push(ut(a,u,s))}return n}function Is(r,e,t,s,n){let o=[];o.push(...Nt(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let E=d.data,u=Oe(E.displayTime);o.push(...Lt(E,u))}else{let E=d.data,u=xt(E.files_modified,n,E.files_read),c=Re(E.created_at),p=c!==a;a=c;let T=t.has(E.id);if(u!==i&&(o.push(...ht(u)),i=u),T){let h=kt(E,s);o.push(...At(E,c,p,h,s))}else o.push(It(E,c,p,s))}return o.push(""),o}function As(r,e,t,s,n,o){return o?Is(r,e,t,s,n):hs(r,e,t,s)}function wt(r,e,t,s,n){let o=[],i=Ns(r);for(let[a,d]of i)o.push(...As(a,d,e,t,s,n));return o}function Pt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function Ft(r,e){let t=[];return e?(t.push(...V("Investigated",r.investigated,m.blue)),t.push(...V("Learned",r.learned,m.yellow)),t.push(...V("Completed",r.completed,m.green)),t.push(...V("Next Steps",r.next_steps,m.magenta))):(t.push(...j("Investigated",r.investigated)),t.push(...j("Learned",r.learned)),t.push(...j("Completed",r.completed)),t.push(...j("Next Steps",r.next_steps))),t}function $t(r,e){return e?Ct(r):pt(r)}function Xt(r,e,t){return!te(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?Dt(r.totalDiscoveryTokens,r.totalReadTokens):lt(r.totalDiscoveryTokens,r.totalReadTokens)}var Ls=Ht.default.join((0,Gt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Cs(){try{return new K}catch(r){if(r instanceof Error&&r.code==="ERR_DLOPEN_FAILED"){try{(0,Bt.unlinkSync)(Ls)}catch(e){e instanceof Error?_.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):_.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return _.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Ds(r,e){return e?Mt(r):Tt(r)}function Ms(r,e,t,s,n,o,i){let a=[],d=Se(e);a.push(...yt(r,d,s,i));let E=t.slice(0,s.sessionCount),u=st(E,t),c=rt(e,u),p=nt(e,s.fullObservationCount);a.push(...wt(c,p,s,n,i));let T=t[0],h=e[0];Pt(s,T,h)&&a.push(...Ft(T,i));let N=tt(e,s,o,n);return a.push(...$t(N,i)),a.push(...Xt(d,s,i)),a.join(`
`).trimEnd()}var ys=new Set(["bugfix","discovery","decision","refactor"]);function vs(r,e,t){let s=Se(r),n={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let d of r){let E=ys.has(d.type)?d.type:"other";n[E]++,d.memory_session_id&&o.add(d.memory_session_id),d.created_at_epoch&&d.created_at_epoch<i&&(i=d.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:r.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:n.bugfix,obs_type_discovery:n.discovery,obs_type_decision:n.decision,obs_type_refactor:n.refactor,obs_type_other:n.other,tokens_injected:s.totalReadTokens,tokens_saved_vs_naive:s.savings,search_strategy:t?"full":"timeline"}}async function be(r,e=!1){let t=qe(),s=r?.cwd??process.cwd(),n=Ve(s),o=r?.projects?.length?r.projects:n.allProjects,i=o[o.length-1]??n.primary;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let a=Cs();if(!a)return{text:"",stats:null};try{let d=r?.platformSource?L(r.platformSource):void 0,E=o.length>1?o:[i],u=Ze(a,E,t,d),c=et(a,E,t,d);return u.length===0&&c.length===0?{text:Ds(i,e),stats:null}:{text:Ms(i,u,c,t,s,r?.session_id,e),stats:vs(u,c,!!r?.full)}}finally{a.close()}}async function Wt(r,e=!1){return(await be(r,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
